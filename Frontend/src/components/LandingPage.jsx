...
export default function LandingPage() {
  ...
  useEffect(() => {
    if (passwordSignup && confirmPasswordSignup && passwordSignup !== confirmPasswordSignup) {
  ...
  const renderShape = (shape, size, color) => {
    switch (shape) {
      ...
      case 'star':
        return (
          <div className={`${color} w-full h-full landing-clip-path-star transform shadow-md`}></div>
        );
      case 'cloud':
        return (
