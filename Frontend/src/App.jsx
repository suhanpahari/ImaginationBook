...
const App = () => {
  ...
  return (
    <div className="h-screen w-screen bg-gray-50 overflow-hidden font-sans">
      {/* Top Toolbar */}
      <div className="fixed top-0 left-0 right-0 bg-white shadow z-10 p-2 flex items-center justify-between">
        <div className="flex space-x-2">
          ...
          <div className="flex space-x-1">
            <div className="relative">
              ...
              {showColorPanel && (
                <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg p-3 z-20 w-56">
          ...
          <div className="relative">
            ...
            {showThicknessPanel && (
              <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg p-3 z-20 w-48">
                {thicknessOptions.map((thickness) => (
                  ...
                  >
                    <div 
                      className="w-12 bg-gray-800 rounded-full mr-2"
          ...
          <div className="relative">
            ...
            {showFillPanel && (
              <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg p-3 z-20 w-64">
                <div className="mb-3">
                  <h4 className="text-sm font-medium text-gray-600 mb-2">Fill Style</h4>
                ...
                {selectedFillStyle.value !== "none" && (
                  <div>
                    <h4 className="text-sm font-medium text-gray-600 mb-2">Fill Color</h4>
                    <div className="grid grid-cols-4 gap-2">
                      {colorOptions.map((color) => (
                        <button
    ...
    <div className="fixed bottom-4 right-4 bg-white rounded-lg shadow-lg p-4 max-w-sm z-20 border border-gray-200 animate-fade-in">
